...
const quickRules = [
  {
    situation: "New patient + HFU + provider listed",
    action: "Schedule with listed provider",
    type: "info",
  },
  {
    situation: "New patient + HFU + no provider",
    action: "Contact Hospital Follow-Up Team",
    type: "warning",
  },
  {
    situation: "Established patient + HFU",
    action: "Schedule with established provider",
    type: "info",
  },
  {
    situation: "Insurance questions",
    action: "Transfer to Insurance Team",
    type: "transfer",
  },
  {
    situation: "Initial colonoscopy",
    action: "Only schedule DAP if eligible",
    type: "warning",
  },
  {
    situation: "Initial endoscopy (EGD)",
    action: "Schedule office visit first",
    type: "warning",
  },
  {
    situation: "Waitlist request",
    action: "Office visits only; patient must already have appt",
    type: "info",
  },
  {
    situation: "Balance over $1,000",
    action: "Cannot schedule procedure — warm transfer collections",
    type: "danger",
  },
];
...
const navCards = [
  {
    ...
    icon: CalendarDays,
    desc: "Appointment types, workflows, rescheduling",
  },
  {
    href: "/routing",
    label: "Department Routing",
    icon: PhoneForwarded,
    desc: "Warm/blind transfers, all departments",
  },
  {
    href: "/scripts",
    label: "Call Scripts",
    icon: MessageSquare,
    desc: "Opening, closing, callbacks, voicemail",
  },
  {
    href: "/locations",
    label: "Locations",
    icon: MapPin,
    desc: "Region rules, abbreviations",
  },
  {
    href: "/disposition",
    label: "Disposition Codes",
    icon: Tags,
    desc: "All 13 disposition code definitions",
  },
  {
    href: "/notes",
    label: "My Notes",
    icon: FileText,
    desc: "Personal reference notes",
  },
];
    ...
    <div className="space-y-8" data-testid="dashboard-page">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Borland Groover — Patient Support Services
        </p>
      ...
      <div>
        ...
        <p className="text-xs text-muted-foreground mt-2">
          High volume days: Monday & Tuesday. AI calls occur on Mondays.
        </p>
      </div>
      ...
      <div>
        ...
        <div className="space-y-2">
          {quickRules.map(({ situation, action, type }) => (
            <div
              key={situation}
              className={`flex items-start gap-3 p-3 rounded-lg border text-sm ${typeColors[type]}`}
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <span className={`font-semibold ${actionColors[type]}`}>
                  {action}
                </span>
              </div>
            </div>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          <div className="flex items-start gap-3 p-3 rounded-lg bg-amber-50 border border-amber-200 dark:bg-amber-950/40 dark:border-amber-800">
            ...
            <div className="text-sm">
              ...
              <p className="text-amber-700 dark:text-amber-400 text-xs mt-1">
                Book appointments 2–3 days out. Absolutely no same-day or
          ...
          <div className="flex items-start gap-3 p-3 rounded-lg bg-amber-50 border border-amber-200 dark:bg-amber-950/40 dark:border-amber-800">
            ...
            <div className="text-sm">
              <p className="font-semibold text-amber-800 dark:text-amber-300">
                Check SharePoint First
              </p>
              <p className="text-amber-700 dark:text-amber-400 text-xs mt-1">
                Always check the Scheduling Cheat Sheet in SharePoint before
          ...
          <div className="flex items-start gap-3 p-3 rounded-lg bg-blue-50 border border-blue-200 dark:bg-blue-950/40 dark:border-blue-800">
            ...
            <div className="text-sm">
              <p className="font-semibold text-blue-800 dark:text-blue-300">
                Phreesia Crucial Rule
              </p>
              <p className="text-blue-700 dark:text-blue-400 text-xs mt-1">
                Do not open anything else in Phreesia under any circumstances.
              </p>
            </div>
          </div>
          <div className="flex items-start gap-3 p-3 rounded-lg bg-blue-50 border border-blue-200 dark:bg-blue-950/40 dark:border-blue-800">
            ...
            <div className="text-sm">
              ...
              <p className="text-blue-700 dark:text-blue-400 text-xs mt-1">
                Gastroenterology and Hepatology only. Including Diabetes and
                Weight Loss.
              </p>
            </div>
          </div>
